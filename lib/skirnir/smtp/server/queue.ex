defmodule Skirnir.Smtp.Server.Queue do
  ...
  def enqueue(id), do: GenServer.call __MODULE__, {:enqueue, id}
  def enqueue(id, ts), do: GenServer.call __MODULE__, {:enqueue, id, ts}
  ...
  defp threshold do
    Application.get_env(:skirnir, :queue_threshold, @threshold)
  end
end
